...
export default function SandboxPage() {
  const images = [
    '/designs/sandbox001.png',
    '/designs/sandbox002.jpg',
    '/designs/sandbox003.jpg',
    '/designs/sandbox004.jpg',
  ];
      ...
      <section className="pt-32 pb-4 px-5 md:px-12 flex flex-col items-center">
        <div className="w-full max-w-6xl">
          ...
          <p
            ...
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            Standees, banners, and mixed-dimension branding assets for Sandbox.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full max-w-6xl mt-12">
          {images.map((src, index) => (
            ...
            >
              <img
                src={src}
                alt={`Sandbox branding asset ${index + 1}`}
